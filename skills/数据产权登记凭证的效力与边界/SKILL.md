...
title: 数据产权登记凭证的效力与边界
source_url: https://mp.weixin.qq.com/s/XhVFB3WznwXIgTY3DbRthw
doc_type: 技术教程
created_at: '2026-06-13T03:31:07Z'
stats:
  glossary_terms: 10
  patterns: 10
  sections: 3
...
| glossary.md | 10 个术语定义 |
| patterns.md | 10 个模式与启发式 |
| cheatsheet.md | 速查表 |
| sections/ | 3 个章节摘要 |

---
*由 Deep Digest 引擎自动生成 · 30.4s*
